...
namespace MinMax
{
	...
	public:
		std::vector<std::string> getOptionNames(Steinberg::int32 rangeKind) const override
		{
			...
			case RANGE::CTL_TABINDEX1_RANGE:
				return { "Strum Strings", "Articulation", "Mute", "Fret Noize", "Other"};
			default:
				return { };
			}
		}
	...
	*/
	...
	{ {
		...
		{ PARAM::STRUM_DECAY, STR16("Strum Decay"), STR16("%"), PF::VALUE::Int, PF::SCALE::Linear, std::nullopt, PF::FLAG::AUTOMATE,                                 UNIT::STRUM, 85, 100, 96, 1, 0 },
		{ PARAM::STRUM_LENGTH, STR16("Strum Length"), STR16("beat"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::BEAT_LENGTH, PF::FLAG::AUTOMATE,                      UNIT::STRUM,  0, 1, 4, 0, 0 },
		...
		{ PARAM::ARP_LENGTH, STR16("Arpegio Length"), STR16("beat"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::BEAT_LENGTH, PF::FLAG::AUTOMATE,                      UNIT::STRUM,  0, 1, 2, 0, 0 },
