	...
	{ 
		{
			...
			{ PARAM::FNOISE_DIST_NEAR, STR16("Fret Noise Distance Near"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::FRET_DISTANCE, PF::FLAG::HIDDEN, UNIT::STRUM, 0, 1, 1, 0, 0 },
			{ PARAM::FNOISE_DIST_FAR, STR16("Fret Noise Distance Far"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::FRET_DISTANCE, PF::FLAG::HIDDEN, UNIT::STRUM, 0, 1, 3, 0, 0 },
