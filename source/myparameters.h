...
namespace MinMax
{
	...
	*/
	...
	{ CHANNEL_SEPARATE, STR16("Channel Separate"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::FLAG_HIDDEN,					U_SYSTEM, 0, 1, 0, 0 },
	{ TRANSPOSE, STR16("Transpose"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, TRANSPOSE_RANGE, PF::FLAG::FLAG_AUTOMATE,							U_SYSTEM, 0, 1, 6, 0 },
	{ SELECTED_ARTICULATION, STR16("Selected Articulation"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, ARTICULATION_RANGE, PF::FLAG::FLAG_AUTOMATE,	U_SYSTEM, 0, 1, 0, 0 },
	{ NEED_SAMPLEBLOCK_ADJUST, STR16("Need Sampleblock Adjust"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::FLAG_HIDDEN,	U_SYSTEM, 0, 1, 0, 0 },
	{ CTL_TABINDEX1, STR16("TabIndex1"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, CTL_TABINDEX1_RANGE, PF::FLAG::FLAG_HIDDEN,						U_SYSTEM, 0, 1, 0, 0 },
	{ OCTAVE, STR16("Octave+"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::FLAG_HIDDEN,										U_SYSTEM, 0, 1, 0, 0 },
	{ ENABLED_MUTE_FNOIZE, STR16("Enabled Mute/Fret Noize"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::FLAG_HIDDEN,		U_SYSTEM, 0, 1, 1, 0 },
	{ ENABLED_ARTICULATION, STR16("Enabled Articulation"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::FLAG_HIDDEN,			U_SYSTEM, 0, 1, 1, 0 },
	...
	{ MUTE_CHANNEL , STR16("Mute Channel"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, MIDI_CHANNEL, PF::FLAG::FLAG_HIDDEN,							U_STRUM,  0,    1,   1, 0 },
	{ MUTE_NOTE_1, STR16("Mute Note 1"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, PITCH, PF::FLAG::FLAG_HIDDEN,									U_STRUM,  0,    1, 103, 0 },
	{ MUTE_NOTE_2, STR16("Mute Note 2"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, PITCH, PF::FLAG::FLAG_HIDDEN,									U_STRUM,  0,    1, 102, 0 },
	...
	{ BRUSH_DECAY, STR16("Brush Decay"), STR16("%"), PF::VALUE::Real, PF::SCALE::Linear, std::nullopt, PF::FLAG::FLAG_AUTOMATE,							U_STRUM, 85,  100,  98, 1},
	{ BRUSH_1_TIME, STR16("Brush 1 Time"), STR16("ms"), PF::VALUE::Real, PF::SCALE::Exponential, std::nullopt, PF::FLAG::FLAG_AUTOMATE,                 U_STRUM,  5,  300,  10, 1},
	{ BRUSH_2_TIME, STR16("Brush 2 Time"), STR16("ms"), PF::VALUE::Real, PF::SCALE::Exponential, std::nullopt, PF::FLAG::FLAG_AUTOMATE,                 U_STRUM,  5,  300,  80, 1},

	{ ARP_LENGTH, STR16("Arpeggio Length"), STR16("beat"), PF::VALUE::Real, PF::SCALE::Linear, BEAT_LENGTH, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   2, 2},

	{ FNOISE_CHANNEL, STR16("Fret Noise Channel"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, MIDI_CHANNEL, PF::FLAG::FLAG_HIDDEN,					U_STRUM,  0,    1,   1, 0 },
	{ FNOISE_NOTE_NEAR, STR16("Fret Noise Note Near"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, PITCH, PF::FLAG::FLAG_HIDDEN,						U_STRUM,  0,    1, 120, 0 },
	{ FNOISE_NOTE_FAR, STR16("Fret Noise Note Far"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, PITCH, PF::FLAG::FLAG_HIDDEN,						U_STRUM,  0,    1, 123, 0 },
	{ FNOISE_DIST_NEAR, STR16("Fret Noise Distance Near"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, FRET_DISTANCE, PF::FLAG::FLAG_HIDDEN,		U_STRUM,  0,    1,   1, 0 },
	{ FNOISE_DIST_FAR, STR16("Fret Noise Distance Far"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, FRET_DISTANCE, PF::FLAG::FLAG_HIDDEN,		U_STRUM,  0,    1,   3, 0 },
	{ FNOISE_VELOCITY, STR16("Fret Noise Velocity"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, MIDI_DATA, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,  127, 100, 0 },

	{ STRINGS_UP_HIGH, STR16("Strings Up High"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,			U_STRUM,  0,    1,   3 - 1, 0 },
	{ STRINGS_UP_LOW, STR16("Strings Up Low"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,				U_STRUM,  0,    1,   2 - 1, 0 },
	{ STRINGS_DOWN_HIGH, STR16("Strings Down High"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,		U_STRUM,  0,    1,   3 - 1, 0 },
	{ STRINGS_DOWN_LOW, STR16("Strings Down Low"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,			U_STRUM,  0,    1,   1 - 1, 0 },
	{ STRINGS_BRUSH_1, STR16("Strings Brush 1"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,			U_STRUM,  0,    1,   MAX_STRINGS - 1, 0 },
	{ STRINGS_BRUSH_2, STR16("Strings Brush 2"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,			U_STRUM,  0,    1,   MAX_STRINGS - 1, 0 },

	{ STR1_OFFSET, STR16("String 1 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, STRING_OFFSET, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   StringSet::CENTER_OFFSET, 0 },
	{ STR2_OFFSET, STR16("String 2 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, STRING_OFFSET, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   StringSet::CENTER_OFFSET, 0 },
	{ STR3_OFFSET, STR16("String 3 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, STRING_OFFSET, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   StringSet::CENTER_OFFSET, 0 },
	{ STR4_OFFSET, STR16("String 4 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, STRING_OFFSET, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   StringSet::CENTER_OFFSET, 0 },
	{ STR5_OFFSET, STR16("String 5 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, STRING_OFFSET, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   StringSet::CENTER_OFFSET, 0 },
	{ STR6_OFFSET, STR16("String 6 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, STRING_OFFSET, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   StringSet::CENTER_OFFSET, 0 },
	{ STR7_OFFSET, STR16("String 7 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, STRING_OFFSET, PF::FLAG::FLAG_AUTOMATE,					U_STRUM,  0,    1,   StringSet::CENTER_OFFSET, 0 },
