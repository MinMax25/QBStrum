...
namespace MinMax
{
	...
	*/
	...
	{ STRINGS_DOWN, STR16("Strings Brush Down"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,			U_STRINGS, 0, 1, STRING_COUNT - 1, 0 },
	{ STRINGS_UP, STR16("Strings Brush Up"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, STRUM_STRINGS_RANGE, PF::FLAG::FLAG_AUTOMATE,				U_STRINGS, 0, 1, STRING_COUNT - 1, 0 },
