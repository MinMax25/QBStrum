...
namespace MinMax
{
	...
	public:
		bool resolve(Steinberg::uint32 id, PF::ValueRange& out) const override
		{
			...
			case RANGE::STRING_OFFSET:       out = { -4, 4, false }; return true;
	...
	*/
	...
	// 全パラメータ数
	inline constexpr size_t PARAM_MAX = 56;

	// 全パラメータ定義
	inline const std::array<PF::ParamDef, PARAM_MAX> paramTable =
	{ {
		{ PARAM::BYPASS, STR16("Bypass"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::SYS_BYPASS,                                         UNIT::SYSTEM, 0, 1, 0, 0, 0 },
		{ PARAM::CHANNEL_SEPALATE, STR16("Channel Sepalate"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::HIDDEN,                         UNIT::SYSTEM, 0, 1, 0, 0, 0 },
		...
		{ PARAM::OCTAVE, STR16("Octabe Up"), STR16(""), PF::VALUE::Bool, PF::SCALE::Linear, std::nullopt, PF::FLAG::HIDDEN,											 UNIT::SYSTEM, 0, 1, 0, 0, 0 },
		...
		{ PARAM::STRUM_SPEED, STR16("Strum Speed"), STR16("ms"), PF::VALUE::Real, PF::SCALE::Exponential, std::nullopt, PF::FLAG::AUTOMATE,                          UNIT::STRUM,  1, 1000, 26, 1, 0 },
		...
		{ PARAM::STRUM_LENGTH, STR16("Strum Length"), STR16("beat"), PF::VALUE::Real, PF::SCALE::Linear, RANGE::BEAT_LENGTH, PF::FLAG::AUTOMATE,                     UNIT::STRUM,  0, 1, 4, 2, 0 },
		{ PARAM::BRUSH_TIME, STR16("Brush Time"), STR16("ms"), PF::VALUE::Real, PF::SCALE::Exponential, std::nullopt, PF::FLAG::AUTOMATE,                            UNIT::STRUM,  5, 300, 30, 1, 0 },
		{ PARAM::ARP_LENGTH, STR16("Arpegio Length"), STR16("beat"), PF::VALUE::Real, PF::SCALE::Linear, RANGE::BEAT_LENGTH, PF::FLAG::AUTOMATE,                     UNIT::STRUM,  0, 1, 2, 2, 0 },
		...
		{ PARAM::FNOISE_DIST_NEAR, STR16("Fret Noise Distance Near"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::FRET_DISTANCE, PF::FLAG::HIDDEN,      UNIT::STRUM,  0, 1, 1, 0, 0 },
		{ PARAM::FNOISE_DIST_FAR, STR16("Fret Noise Distance Far"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::FRET_DISTANCE, PF::FLAG::HIDDEN,        UNIT::STRUM,  0, 1, 3, 0, 0 },
		{ PARAM::FNOISE_VELOCITY, STR16("Fret Noise Velocity"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::MIDI_DATA, PF::FLAG::AUTOMATE,                  UNIT::STRUM,  0, 127, 100, 0, 0 },
		...
		{ PARAM::STR1_OFFSET, STR16("String 1 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::STRING_OFFSET, PF::FLAG::AUTOMATE,                  UNIT::STRUM,  0, 1, 0, 0, 0 },
		{ PARAM::STR2_OFFSET, STR16("String 2 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::STRING_OFFSET, PF::FLAG::AUTOMATE,                  UNIT::STRUM,  0, 1, 0, 0, 0 },
		{ PARAM::STR3_OFFSET, STR16("String 3 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::STRING_OFFSET, PF::FLAG::AUTOMATE,                  UNIT::STRUM,  0, 1, 0, 0, 0 },
		{ PARAM::STR4_OFFSET, STR16("String 4 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::STRING_OFFSET, PF::FLAG::AUTOMATE,                  UNIT::STRUM,  0, 1, 0, 0, 0 },
		{ PARAM::STR5_OFFSET, STR16("String 5 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::STRING_OFFSET, PF::FLAG::AUTOMATE,                  UNIT::STRUM,  0, 1, 0, 0, 0 },
		{ PARAM::STR6_OFFSET, STR16("String 6 Offset"), STR16("fret"), PF::VALUE::Int, PF::SCALE::Linear, RANGE::STRING_OFFSET, PF::FLAG::AUTOMATE,                  UNIT::STRUM,  0, 1, 0, 0, 0 },
		...
		{ PARAM::UP, STR16("Up"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                                      UNIT::TRIGGER, 0, 1, 62, 0, 0 },
		{ PARAM::DOWN_HIGH, STR16("Down High"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                        UNIT::TRIGGER, 0, 1, 61, 0, 0 },
		{ PARAM::DOWN, STR16("Down"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                                  UNIT::TRIGGER, 0, 1, 60, 0, 0 },
		{ PARAM::DOWN_LOW, STR16("Down Low"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                          UNIT::TRIGGER, 0, 1, 59, 0, 0 },
		{ PARAM::MUTE_1, STR16("Mute 1"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                              UNIT::TRIGGER, 0, 1, 58, 0, 0 },
		{ PARAM::MUTE_2, STR16("Mute 2"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                              UNIT::TRIGGER, 0, 1, 57, 0, 0 },
		{ PARAM::ARPEGGIO_1, STR16("String 1"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                        UNIT::TRIGGER, 0, 1, 72, 0, 0 },
		{ PARAM::ARPEGGIO_2, STR16("String 2"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                        UNIT::TRIGGER, 0, 1, 71, 0, 0 },
		{ PARAM::ARPEGGIO_3, STR16("String 3"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                        UNIT::TRIGGER, 0, 1, 69, 0, 0 },
		{ PARAM::ARPEGGIO_4, STR16("String 4"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                        UNIT::TRIGGER, 0, 1, 67, 0, 0 },
		{ PARAM::ARPEGGIO_5, STR16("String 5"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                        UNIT::TRIGGER, 0, 1, 65, 0, 0 },
		{ PARAM::ARPEGGIO_6, STR16("String 6"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                        UNIT::TRIGGER, 0, 1, 64, 0, 0 },
		
		{ PARAM::OPEN1 , STR16("Open 1"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                              UNIT::ARTICULATION, 0, 1, 24, 0, 0 },
		{ PARAM::OPEN2, STR16("Open 2"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                               UNIT::ARTICULATION, 0, 1, 0, 0, 0 },
		{ PARAM::HAM_LEG, STR16("Hammer/Legato"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                      UNIT::ARTICULATION, 0, 1, 25, 0, 0 },
		{ PARAM::MUTE, STR16("Mute"), STR16(""), PF::VALUE::Int, PF::SCALE::Linear, RANGE::PITCH, PF::FLAG::HIDDEN,                                                  UNIT::ARTICULATION, 0, 1, 26, 0, 0 },
